...
<Tip>
  Before a task touches important files, ask Claude to confirm your undo path: *"Before you change anything, tell me how we can undo this if I don't like the result."* See [Undo & Rewind](/agentic-ai/claude-code/best-practices/undo-and-rewind).
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="The Controls Worth Knowing" icon="sliders" href="/agentic-ai/claude-code/first-session/controls-worth-knowing">
    Learn the few buttons and menus that matter
  </Card>
</CardGroup>
