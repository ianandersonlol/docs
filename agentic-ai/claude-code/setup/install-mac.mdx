...
<Warning>
  **The free Claude plan does not include Claude Code in the desktop app.** For this guide, use a paid plan — **Pro**, **Max**, **Team**, or **Enterprise**. If you sign in and the Code features won't work, this is almost always why.
</Warning>
