...
RFdiffusion is a diffusion-based model for de novo protein structure generation. It can design new protein backbones, scaffold functional motifs, and generate binders.
