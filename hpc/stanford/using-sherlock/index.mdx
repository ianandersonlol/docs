...
<Tabs>
  <Tab title="SSH">
    ...
    Replace `YOUR_SUNETID` with your Stanford SUNet ID. You'll need to authenticate with your password and two-factor authentication.
  </Tab>
  <Tab title="OnDemand">
...
- **Office Hours:** Check the [SRCC website](https://srcc.stanford.edu/) for schedule
