...
When SLURM preempts your job, it sends a signal before killing it. You can catch this signal to save a final checkpoint:
...
signal.signal(signal.SIGCONT, handle_preemption)  # SLURM preemption
```
