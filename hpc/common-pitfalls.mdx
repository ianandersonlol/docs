...
**Solution:** Use [interactive sessions](/hpc/job-submission#interactive-sessions) or submit batch jobs.
...
<Tip>
  When something fails, check the error output carefully. SLURM usually tells you what went wrong—the message just might be buried in a lot of other output.
</Tip>
