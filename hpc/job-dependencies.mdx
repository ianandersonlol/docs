...
| `singleton` | Only one job with this name can run at a time (I'm not sure why you would use this, personally. If it was me, I would use an array job with a maximum of 1 job at a time, for instance `#SBATCH --array=1-100%1`) |
