---
title: Using HIVE
description: Comprehensive guide to using the HIVE HPC cluster at UC Davis
---

The HIVE cluster is UC Davis's primary high-performance computing resource, managed by the High-Performance Computing Core Facility (HPCCF). This guide covers everything you need to start running jobs on HIVE.

<Note>
  Before using HIVE, you'll need to set up your account. See [Setting Up Your HIVE Account](/hpc/uc-davis/getting-started-hive) if you haven't done so.
</Note>
...
The cluster uses a **fair-share scheduling system** where job priority is influenced by past usage and account allocation.
...
<Tabs>
  ...
  <Tab title="Open OnDemand">
    ...
    **URL:** [https://hive.hpc.ucdavis.edu/](https://hive.hpc.ucdavis.edu/)

    <Warning>
      Requires UC Davis VPN or campus network connection.
    </Warning>
  </Tab>
</Tabs>
