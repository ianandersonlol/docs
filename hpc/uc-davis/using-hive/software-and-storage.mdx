...
Before moving on, try the [Cluster Best Practices Quiz](/hpc/uc-davis/using-hive/cluster-best-practices-quiz) to make sure the most important HIVE usage patterns are locked in.
